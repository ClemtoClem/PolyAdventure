#ifndef __MOB_SKELETON_H__
#define __MOB_SKELETON_H__
...
ENTITY *Mob_Skeleton_newFromArray(float x, float y, DirectionFacing direction, Sint32 dispTileSize, ARRAY *init);
...
void Mob_Skeleton_idle(ENTITY *entity);

#endif /* __MOB_SKELETON_H__ */